/* =====================================================================================
   ...
   -------------------------------------------------------------------------------------
   This file ONLY contains Indian Economy questions. Edit ONLY this file to add/update
   Indian Economy questions — you never need to open index.html or any other subject file.
   ...
   HOW TO ADD A WHOLE NEW SET (e.g. "Indian Economy Set 3"):
...
const SUBJECT_ECONOMY = {
  name: "Indian Economy",
  icon: "💰",
  sets: [
    { title: "Indian Economy Set 1", questions: [
      {q:"RBI was nationalized in:", opts:["1935","1949","1955","1969"], correct:1}
    ]}
  ]
};
