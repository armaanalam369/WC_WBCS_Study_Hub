/* =====================================================================================
   ...
   -------------------------------------------------------------------------------------
   This file ONLY contains Chemistry questions. Edit ONLY this file to add/update
   Chemistry questions — you never need to open index.html or any other subject file.
   ...
   HOW TO ADD A WHOLE NEW SET (e.g. "Chemistry Set 3"):
...
const SUBJECT_CHEMISTRY = {
  ...
  icon: "🧪",
  sets: [
    { title: "Chemistry Set 1", questions: [
      {q:"pH value of pure water is:", opts:["5","7","9","0"], correct:1},
      {q:"Which gas is most abundant in Earth's atmosphere?", opts:["Oxygen","Carbon Dioxide","Nitrogen","Hydrogen"], correct:2}
    ]}
  ]
};
